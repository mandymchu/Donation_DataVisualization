queue()
    .defer(d3.json, "/donorschoose/projects") // Read the projects data
    .defer(d3.json, "static/geojson/us-states.json") // Read US states json file
    .await(makeGraphs);
...
function makeGraphs(error, projectsJson, statesJson) {
    ...
    // For each chart, pass the parameters
	timeChart
		.width(600)
		.height(160)
